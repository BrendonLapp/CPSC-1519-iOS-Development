...
class ManufacturerTableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        // Configure the cell...
        let manufacturuer = dataManager.manufacturers[indexPath.row]
        
        cell.textLabel?.text = manufacturuer
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        let phoneVC = segue.destination as! ManufacturerPhoneTableViewController
        
        let selectedCell = tableView.indexPathForSelectedRow?.row
        phoneVC.manufacturerName = dataManager.manufacturers[selectedCell!]
